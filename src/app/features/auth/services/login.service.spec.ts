...
describe('LoginService', () => {
  ...
  it('should verify login and map a successful response', async () => {
    ...
    const req = httpMock.expectOne(
      'https://demo.api.eyewacloud.com/api/auth/VerifyUserLogin?LoginName=Canada&Password=a1b2c3d4',
    );
  ...
  it('should reject empty login result as invalid credentials', async () => {
    ...
    httpMock
      .expectOne(
        'https://demo.api.eyewacloud.com/api/auth/VerifyUserLogin?LoginName=bad&Password=wrong',
      )
      .flush({
        status: '200',
        message: 'Success',
  ...
  it('should reject when apiUrl is missing', async () => {
    ...
    appConfigStub.settings.apiUrl = 'https://demo.api.eyewacloud.com/api';
  });
});
