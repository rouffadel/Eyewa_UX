...
describe('InsuranceService', () => {
  ...
  it('should load all insurance companies', async () => {
    ...
    const req = httpMock.expectOne(
      'https://demo.api.eyewacloud.com/api/insurance/GetAllInsuranceCompanies',
    );
  ...
  it('should load insurance by sales id', async () => {
    ...
    const req = httpMock.expectOne(
      'https://demo.api.eyewacloud.com/api/insurance/GetInsuranceBySalesId?salesId=114135',
    );
    expect(req.request.method).toBe('GET');
  ...
  it('should post SaveSalesInsurance payload', async () => {
    ...
    const req = httpMock.expectOne(
      'https://demo.api.eyewacloud.com/api/insurance/SaveSalesInsurance',
    );
  ...
  it('should reject save when API returns non-200 status', async () => {
    ...
    httpMock
      .expectOne('https://demo.api.eyewacloud.com/api/insurance/SaveSalesInsurance')
      .flush({
        status: '400',
