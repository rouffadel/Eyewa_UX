...
describe('BrandService', () => {
  ...
  it('should load brands from GetBrand API array response', async () => {
    ...
    const req = httpMock.expectOne(
      'https://localhost:44314/api/products/GetBrand?BrandName=J',
    );
  ...
  it('should load brands from legacy table response', async () => {
    ...
    const req = httpMock.expectOne(
      'https://localhost:44314/api/products/GetBrand?BrandName=A',
    );
    expect(req.request.method).toBe('GET');
  ...
  it('should load brands when objresult is a direct array', async () => {
    ...
    const req = httpMock.expectOne(
      'https://localhost:44314/api/products/GetBrand?BrandName=b',
    );
    req.flush({
      status: '200',
      message: 'Success',
  ...
  it('should trim brand name in query', async () => {
    ...
    const req = httpMock.expectOne(
      'https://localhost:44314/api/products/GetBrand?BrandName=Ray',
    );
    req.flush({
      status: '200',
      message: 'Success',
