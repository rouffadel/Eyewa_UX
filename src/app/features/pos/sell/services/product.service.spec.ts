...
describe('ProductService', () => {
  ...
  it('should load products from GetProduct API', async () => {
    ...
    const req = httpMock.expectOne(
      'https://localhost:44314/api/products/GetProduct?CategoryId=6&BrandId=8&StoreId=2&ProductName=b',
    );
  ...
  it('should trim product name in query', async () => {
    ...
    const req = httpMock.expectOne(
      'https://localhost:44314/api/products/GetProduct?CategoryId=1&BrandId=2&StoreId=3&ProductName=ray',
    );
    req.flush({
      status: '200',
      message: 'Success',
  ...
  it('should search products by key via GetProduct with ProductName only', async () => {
    ...
    const req = httpMock.expectOne(
      'https://localhost:44314/api/products/GetProduct?ProductName=B',
    );
    expect(req.request.method).toBe('GET');
