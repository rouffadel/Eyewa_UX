...
Curated, structured information distilled from `raw-knowledge/`. Safe for agents and developers to rely on during implementation.
...
Keep files focused. Link back to raw sources when traceability matters.
